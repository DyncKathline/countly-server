...
then
    ...
    $DIR/../../../node_modules/.bin/jsdoc $DIR/../../../frontend/express/app.js $DIR/../../../frontend/express/config.js $DIR/../../../frontend/express/version.info.js $DIR/../../../frontend/express/locale.conf.js $DIR/../../../frontend/express/libs/ -R $DIR/../../../README.md -c  $DIR/../../../jsdoc_conf.json -d  $DIR/../../../frontend/express/public/docs/app ;
fi
