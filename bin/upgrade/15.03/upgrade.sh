...
cp -f $DIR/../../../frontend/express/public/javascripts/countly/countly.config.js $DIR/../../../frontend/express/public/javascripts/countly/countly.config.js
...
cp -f $DIR/../../../api/config.js $DIR/../../../api/config.js

#create app configuration file from sample
cp -f $DIR/../../../frontend/express/config.js $DIR/../../../frontend/express/config.js
